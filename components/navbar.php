    ...
    <div class="navbar">
        ...
        <div class="nav-links">
            <?php if ($user['role'] === 'admin'): ?>
                <a href="/JobBoardPro/admin/profile.php">My Profile</a>
            ...
            <?php else: ?>
                <a href="/JobBoardPro/jobseeker/profile.php">My Profile</a>
                <a href="/JobBoardPro/jobseeker/dashboard.php">Dashboard</a>
                <a href="/JobBoardPro/jobseeker/apply.php">Apply</a>
            <?php endif; ?>
